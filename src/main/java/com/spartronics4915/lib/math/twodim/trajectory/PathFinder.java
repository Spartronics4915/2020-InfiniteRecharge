...
public class PathFinder
{
    ...
    /** Meters */
    private final Vector2D mRobotCornerTopRight, mRobotCornerTopLeft, mRobotCornerBottomLeft,
        mRobotCornerBottomRight;
    /** Meters */
    ...
    {
        var waypoints = findWaypoints(toVector(start.getTranslation()),
            toVector(end.getTranslation()), additionalRestrictedAreas);
    ...
    public List<Vector2D> findWaypoints(Vector2D start, Vector2D end,
        Rectangle2d... additionalRestrictedAreas)
    {
    ...
    private Set<Line> createLines(Set<Rectangle2d> effectiveRestrictedAreas)
    {
        ...
        class LineTriple
        {
            ...
            public boolean equals(Object o)
            {
                ...
                return this.vecOne.equals(((LineTriple) o).vecOne)
                    && this.vecTwo.equals(((LineTriple) o).vecTwo);
            }
        }
        ...
        for (var comboPair : Pair.combinationPairs(restrictedWallLines))
        {
            ...
            lines.add(
                new Line(comboPair.first.vecOne.add(comboPair.second.vecOne).scalarMultiply(0.5),
    ...
    {
        return new Rectangle2d((point.getX() - mRobotSize / 3), (point.getY() - mRobotSize / 3),
            (mRobotSize / 3 * 2), (mRobotSize / 3 * 2));
    }
