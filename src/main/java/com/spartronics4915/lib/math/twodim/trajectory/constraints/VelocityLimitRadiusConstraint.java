...
public class VelocityLimitRadiusConstraint implements TimingConstraint<Pose2dWithCurvature>
{
    ...
    public VelocityLimitRadiusConstraint(Translation2d centerMeters, double radiusMeters,
    ...
    {
        return state.getTranslation().getDistance(mCenter) <= mRadius ? mVelocityLimit
