...
public class Rectangle2d
{
    ...
    {
        return mX < r.mX + r.mWidth && mX + mWidth > r.mX && mY < r.mY + r.mHeight
            && mY + mHeight > r.mY;
    }

    public boolean contains(Translation2d t)
    {
        return (t.getX() > mX && t.getX() < mX + mWidth)
            && (t.getY() > mY && t.getY() < mY + mHeight);
    }
    ...
    public boolean doesCollide(Rectangle2d rectangle, Translation2d translation)
    {
        ...
        Rectangle2d boxRect = new Rectangle2d(rectangle.getTopLeft(), rectangle.getBottomRight(),
            rectangle.getTopLeft().translateBy(translation),
            rectangle.getBottomRight().translateBy(translation));
        ...
        return entryTime <= exitTime && (xEntry >= 0.0 || yEntry >= 0.0)
            && (xEntry < 1.0 || yEntry < 1.0);
    }
