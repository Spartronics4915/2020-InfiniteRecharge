...
public class Launcher extends SpartronicsSubsystem
{
    ...
    public Launcher()
    {
        ...
        try
        {
            ...
            mFlywheelFollowerMotor = new SpartronicsMax(Constants.Launcher.kFlywheelFollowerID,
                    null);
    ...
    {
        // returns the current angle the turret is facing relative to straight
        // ahead/home position
    ...
    {
        // returns whether or not the target is within the range that the turret can
        // rotate to, used by driver
    ...
    {
        // returns whether or not the target is within the range that the shooter can
        // shoot, used by driver
